...
function SingerDetails(){
    ...
    return(
        <div>
            <p className="home"><NavLink to={"/home"} className="link" ><span>Home</span></NavLink></p>
            <img src={`../covers/${singer.cover}.jpg`} className="img" alt="Singer Cover" style={{height: '200px', width:'200px'}}/>
